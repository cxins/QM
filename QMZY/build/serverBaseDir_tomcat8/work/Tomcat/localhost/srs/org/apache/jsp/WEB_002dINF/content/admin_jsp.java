 ...
 * Generated at: 2017-07-03 12:49:08 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t+ '</td><td><a href=\"javascript:void(0);\"  onclick=\"addSection('+ ca +')\">加入课表</a>'\r\n");
      out.write("\t\t\t\t\t\t+ '</td><td><a href=\"javascript:void(0);\"  onclick=\"delectCourse('+ ca +')\">删除课程</a></td></tr>';\r\n");
      ...
      out.write("\t\t\t\t\t\t+ '</td><td>'\r\n");
      out.write("\t\t\t\t\t\t+ s.course\r\n");
      out.write("\t\t\t\t\t\t+ '</td><td><a href=\"#\">删除排课</a></td></tr>';\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input  type=\"text\" id=\"courseNo\" />\r\n");
      out.write("\t\t\t\t\t\t\t<label>课程名称</label> \r\n");
      out.write("\t\t\t\t\t\t\t<input  type=\"text\" id=\"courseName\" /> \r\n");
      out.write("\t\t\t\t\t\t\t<label>学分</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input  type=\"text\" id=\"credits\" /> \r\n");
      out.write("\t\t\t\t\t\t\t<label>先修课程</label> \r\n");
      out.write("\t\t\t\t\t\t\t<input  type=\"text\" id=\"prerequisite\" /><br />\r\n");
      out.write("\t\t\t\t\t\t\t<button onclick=\"addCourse()\" class=\"btn btn-default btn-lg btn-block\">添加课程</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td>学分</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>先修课程</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>加入课表</td>\r\n");
