...
<body>
 <div class="main">
		...
		<div id="demo-box">
			...
			<a id="eg1" class="button" href="addcourse">添加课程</a>
			<a id="eg2" class="button" href="allcourse">全部课程</a>		
			<a id="eg3" class="button" href="allsection">排课情况</a>
	    	<a id="eg2" class="button" href="professoradd">教师添加</a>	
	    	<a id="eg3" class="button" href="professorManage">教师查询</a>	
